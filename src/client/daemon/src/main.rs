...
fn ensure_config_exists_and_updated() {
    if let Some(config_dir) = dirs::config_dir() {
        ...
        if env_path.exists() {
            ...
            existing_content.push_str("# This file is automatically generated. You can uncomment and modify these values.\n\n");
        }
        ...
        let settings = vec![
            ...
            (
                ...
                "# The output mode for the transcribed text.\n# Options: \"type\" (simulated keyboard injection) or \"clipboard\" (Wayland wl-copy to clipboard).\n# Default: type\n# AI_VOICE_OUTPUT_MODE=type\n"
            ),
            (
                "AI_VOICE_TYPING_DELAY",
                "# If using \"type\" mode, this is the pause (in milliseconds) between each consecutive keystroke.\n# Increase this if Wayland is dropping keystrokes or modifiers are getting stuck.\n# Default: 2\n# AI_VOICE_TYPING_DELAY=2\n"
            ),
            (
                "AI_VOICE_TYPING_HOLD",
                "# If using \"type\" mode, this is how long (in milliseconds) each virtual key is held down before releasing.\n# Default: 2\n# AI_VOICE_TYPING_HOLD=2\n"
            ),
        ];
...
fn main() -> Result<()> {
    // 1. Auto-generate or update the config file to ensure discoverability
